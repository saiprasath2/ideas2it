        ...
        while (!isExit) {
            ...
            case 4:
                ...
                try {
                    ...
                    if (employerDetail != null && employerDetail.isRemoved == false) {
                        String pattern = "| %-6s | %-15s | %-15s | %-15s | %-30s | %-15s |\n";
                        System.out.format(pattern, "Id", "Name", "Contact"
                                          , "Department", "project", "Age");
                        System.out.format(pattern, employerDetail.getId()
                                          , employerDetail.getName()
                                          , employerDetail.getNumber() 
                ...
                try {
                    ...
                    if (employer != null && employer.isRemoved == false) {
                        ...
                        case 3:
                            ...
                            employer.setNumber(newContactNumber);
                            break;
